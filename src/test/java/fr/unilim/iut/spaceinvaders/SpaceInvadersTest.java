...
public class SpaceInvadersTest {
   ...
   @Test
	public void VaisseauImmobile_DeplacerVaisseauVersLaGauche() {
	   ...
	   spaceinvaders.positionnerUnNouveauVaisseau(new Dimensions(3,2),new Position(0,9), 3);
       spaceinvaders.deplacerVaisseauVersLaGauche();
   ...
   public void test_VaisseauAvancePartiellement_DeplacerVaisseauVersLaDroite() {
      ...
      spaceinvaders.positionnerUnNouveauVaisseau(new Dimensions(3,2),new Position(10,9),3);
      spaceinvaders.deplacerVaisseauVersLaDroite();
      assertEquals("" + 
      "...............\n" + 
      "...............\n" +
