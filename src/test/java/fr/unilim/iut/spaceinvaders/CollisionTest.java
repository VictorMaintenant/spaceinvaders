...
public class CollisionTest {
	...
	public void test_detecterCollisionEntreDeuxSprites() {
		...
		spaceinvaders.deplacerMissile();
		 ...
		 assertEquals(true, Collision.detecterCollision(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
	@Test
	public void test_détectionColisionMissileHauteurEnvahisseur() {
		...
		assertEquals(true, Collision.sprite1HauteurSprite2(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
	...
	public void test_détectionColisionMissileCentreEnvahisseur() {
		...
		assertEquals(true, Collision.sprite1DansSprite2(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
	...
	public void test_détecttionColisionMissileGaucheBasEnvahisseur() {
		...
		assertEquals(true, Collision.droiteSprite1DansSprite2(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
	...
	public void test_détecttionColisionMissileDroiteBasEnvahisseur() {
		...
		assertEquals(true, Collision.gaucheSprite1DansSprite2(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
	...
	public void test_pasDeColisionMissileEnvahisseurDroite() {
		...
		assertEquals(false, Collision.detecterCollision(spaceinvaders.recupererMissile().get(0), spaceinvaders.recupererEnvahisseur().get(0)));
	}
